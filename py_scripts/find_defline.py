...
accessions = open('D+C.acc')
blast = open('D+C.dmnd.out')
out = open('D+C.dmnd_hits.defline.tsv', 'w')
errors_def = open('D+C.defline_errors.txt', 'w')
errors_blast = open('D+C.dmnd_errors.txt', 'w')
