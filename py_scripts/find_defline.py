...
accessions = open('D+B.acc')
blast = open('D+B.dmnd.out')
out = open('D+B.dmnd_hits.defline.tsv', 'w')
errors_def = open('D+B.defline_errors.txt', 'w')
errors_blast = open('D+B.dmnd_errors.txt', 'w')
