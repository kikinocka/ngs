...
accessions = open('D+H.acc')
blast = open('D+H.dmnd.out')
out = open('D+H.dmnd_hits.defline.tsv', 'w')
errors_def = open('D+H.defline_errors.txt', 'w')
errors_blast = open('D+H.dmnd_errors.txt', 'w')
