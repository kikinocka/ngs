...
accessions = open('H-3_N.acc')
blast = open('H-3_N.dmnd.out')
out = open('H-3_N.dmnd_hits.defline.tsv', 'w')
errors_def = open('H-3_N.defline_errors.txt', 'w')
errors_blast = open('H-3_N.dmnd_errors.txt', 'w')
