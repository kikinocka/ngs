...
accessions = open('D+I.acc')
blast = open('D+I.dmnd.out')
out = open('D+I.dmnd_hits.defline.tsv', 'w')
errors_def = open('D+I.defline_errors.txt', 'w')
errors_blast = open('D+I.dmnd_errors.txt', 'w')
