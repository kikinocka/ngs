...
accessions = open('D+J.acc')
blast = open('D+J.dmnd.out')
out = open('D+J.dmnd_hits.defline.tsv', 'w')
errors_def = open('D+J.defline_errors.txt', 'w')
errors_blast = open('D+J.dmnd_errors.txt', 'w')
