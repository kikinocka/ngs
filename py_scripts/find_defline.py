...
accessions = open('D+D.acc')
blast = open('D+D.dmnd.out')
out = open('D+D.dmnd_hits.defline.tsv', 'w')
errors_def = open('D+D.defline_errors.txt', 'w')
errors_blast = open('D+D.dmnd_errors.txt', 'w')
