...
parser.add_argument('-i', '--infile', help='Diamond outfile(s) to be taxified', default="batch")#required=True)
...
parser.add_argument('-t', '--test_mode', help='Testing mode to allow checking tmp files', action="store_true", default=True)
...
with open("errors.log", "a") as errorfile:
	errorfile.write("Program started {}\n".format(current_time))
