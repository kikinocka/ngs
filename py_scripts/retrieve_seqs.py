...
files = [x for x in os.listdir() if x.endswith('Btri_possible_cont.acc')]
database = '/storage/brno3-cerit/home/kika/blasto_comparative/blobtools/assemblies/Btri.platanus_rnd2_scaffold.l500.gapcloser.fa'
