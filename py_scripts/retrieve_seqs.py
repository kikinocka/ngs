...
files = [x for x in os.listdir() if x.endswith('Oeli_possible_cont2.acc')]
database = '/mnt/data/kika/blastocrithidia/o_eliasi/scaff_gap/Oeli.platanus_rnd2_scaffold.l500.gapcloser.fa'
