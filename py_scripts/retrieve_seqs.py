...
files = [x for x in os.listdir() if x.endswith('aminotransferases.D-_vs_D+.D-UP.fwd.acc')]
database = '/Users/kika/ownCloud/diplonema/diff_expression/D-_vs_D+.D-UP.fasta'
