...
sequences = SeqIO.parse('/home/kika/MEGAsync/blasto_project/orthofinder/sg_ogs/jac_renamed/bexlh_ins_nt.txt', 'fasta')
table = open('/home/kika/MEGAsync/blasto_project/orthofinder/sg_ogs/jac_renamed/bexlh_ins_cu.tsv', 'w')
