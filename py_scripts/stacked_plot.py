...
# os.chdir('/Users/kika/ownCloud/oil_sands/Lane26_18S_V9/supergroups/ver2-metamonads_cont_removed/')
# df = pd.read_csv('supergroups_noOct10-2018-P3S_S72.tsv', sep='\t')
# # print(df)
...
# ax.set_xlabel('OTU count', fontsize=5)
...
# plt.tight_layout()
# # plt.show()
# plt.savefig('supergroups_noOct10-2018-P3S_S72.pdf', dpi=300)
