...
os.chdir('/Users/kika/ownCloud/oil_sands/Lane26_18S_V9/metamonads/18S_fornicata/')
existing = 'fornicata_eukref.aln'
add = 'fornicata_otus.fa'
out = 'fornicata.mafft.aln'
log = 'fornicata.mafft.log'
