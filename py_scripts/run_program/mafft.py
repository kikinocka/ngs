...
#align de-novo
os.chdir('/Users/kika/ownCloud/membrane-trafficking/trees/RABs/rabs2-4-14/ver2/')
...
# existing = 'queries/ARFs/sarB.mafft.aln'
# add = 'trees/ARFs/sar1-sarB/euglenozoans.fa'
# out = 'trees/ARFs/sar1-sarB/sar1-sarB.mafft.aln'
# log = 'trees/ARFs/sar1-sarB/sar1-sarB.mafft.log'
...
# # fasta = 'otu.fa'
# input = 'ag-smap-acap.mafft.in'
# table = 'ag-smap-acap.mafft.table'
