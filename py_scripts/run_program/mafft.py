...
existing = 'diplonemids_all/trees/SNAREs/r.mafft.aln'
add = 'angomonas_SNAREs/adea_r.fa'
out = 'angomonas_SNAREs/trees/r.mafft.aln'
log = 'angomonas_SNAREs/trees/r.mafft.log'
