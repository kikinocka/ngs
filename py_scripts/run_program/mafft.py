...
#align de-novo
os.chdir('/Users/kika/ownCloud/kinetoplastids/angomonas/LOPIT-DC/EAPs/hmmsearch/rnd2/')
files = [x for x in os.listdir() if x.endswith('CAD2216821.2.fa')]
# files = [x for x in os.listdir() if x.startswith('CAD2219389')]
