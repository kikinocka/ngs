...
existing = 'old/discoba_mlsb/euglenozoa/euglenozoa.mafft.aln'
add = 'euglenozoa/ver2/V9.fa'
out = 'euglenozoa/ver2/euglenozoa_V9.mafft.aln'
log = 'euglenozoa/ver2/euglenozoa_V9.mafft.log'
