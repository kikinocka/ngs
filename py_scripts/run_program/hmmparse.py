...
files = [x for x in os.listdir() if x.startswith('donna6_Superclade0')]
db = SeqIO.parse('/home/users/kika/schizosaccharomyces_japonicus/donna6.Trinity_translated.fa', 'fasta')
