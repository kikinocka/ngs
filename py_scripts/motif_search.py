...
os.chdir('/Dcko/MEGAsync/Data/proteromonas/')
proteins = SeqIO.parse('Proteromonas_l_proteins.fasta', 'fasta')
...
with open('proteromonas.possibly_peroxisomal.fa', 'w') as out:
