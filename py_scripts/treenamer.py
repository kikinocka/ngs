...
os.chdir('/Users/kika/ownCloud/membrane-trafficking/diplonemids_all/mantamonas/ARFs/ver2/combined/')
trees = [x for x in os.listdir() if x.endswith('.tre')]

#file in format Acc. number \t name of organism \n
names = open('/Users/kika/ownCloud/membrane-trafficking/diplonemids_all/mantamonas/ARFs/ver2/arfs.codes_names.txt')
