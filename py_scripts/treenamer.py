...
os.chdir('/Users/kika/ownCloud/membrane-trafficking/trees/SNAREs/combined/qb/')
trees = [x for x in os.listdir() if x.endswith('.result')]

#file in format Acc. number \t name of organism \n
names = open('/Users/kika/ownCloud/membrane-trafficking/trees/SNAREs/combined/qb_acc_codes.txt')
