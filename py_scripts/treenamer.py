...
os.chdir('/Users/kika/ownCloud/archamoebae/trees/Rho/ver7_muscle/RAxML/')
trees = [x for x in os.listdir() if x.endswith('RAxML_bipartitions.miro.CD')]

#file in format Acc. number \t name of organism \n
names = open('/Users/kika/ownCloud/archamoebae/trees/Rho/ver7_muscle/miro_codes_names.txt')
