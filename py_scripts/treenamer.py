...
os.chdir('/Users/kika/ownCloud/membrane-trafficking/trees/RABs/endocytic/ver5/RAxML/')
trees = [x for x in os.listdir() if x.endswith('+raxml.tre')]

#file in format Acc. number \t name of organism \n
names = open('/Users/kika/ownCloud/membrane-trafficking/trees/RABs/endocytic/ver5/endocytic_codes_names.txt')
