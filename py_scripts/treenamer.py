...
os.chdir('/Users/kika/ownCloud/membrane-trafficking/trees/SM/ver4/combined/')
trees = [x for x in os.listdir() if x.endswith('.tre')]

#file in format Acc. number \t name of organism \n
names = open('/Users/kika/ownCloud/membrane-trafficking/trees/SM/ver4/sm_names_codes.txt')
