...
os.chdir('/Users/kika/ownCloud/membrane-trafficking/diplonemids_all/trees/ARFs/ph-arf/ver3/combined/')
trees = [x for x in os.listdir() if x.endswith('+iqt.tre')]

#file in format Acc. number \t name of organism \n
names = open('/Users/kika/ownCloud/membrane-trafficking/diplonemids_all/trees/ARFs/ph-arf/ver3/arfs_reduced.codes_names.txt')
