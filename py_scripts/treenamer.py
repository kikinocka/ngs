...
os.chdir('/Users/kika/ownCloud/membrane-trafficking/trees/COPII/ver6/RAxML/')
trees = [x for x in os.listdir() if x.endswith('bipartitions.sec31')]

#file in format Acc. number \t name of organism \n
names = open('/Users/kika/ownCloud/membrane-trafficking/trees/COPII/ver6/sec31_codes_names.txt')
