...
os.chdir('/Users/kika/ownCloud/membrane-trafficking/trees/RABs/endocytic/ver4/combined/')
trees = [x for x in os.listdir() if x.endswith('+raxml.tre')]

#file in format Acc. number \t name of organism \n
names = open('/Users/kika/ownCloud/membrane-trafficking/trees/RABs/endocytic/ver4/endocytic_acc_names.txt')
