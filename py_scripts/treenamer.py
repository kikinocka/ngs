...
os.chdir('/Users/kika/ownCloud/archamoebae/trees/AK/ver7/RAxML/')
trees = [x for x in os.listdir() if x.endswith('RAxML_bipartitions.ak.CD')]

#file in format Acc. number \t name of organism \n
names = open('/Users/kika/ownCloud/archamoebae/trees/AK/ver7/ak_codes_names.txt')
