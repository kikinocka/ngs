...
os.chdir('/Users/kika/ownCloud/membrane-trafficking/trees/ARFs/sar1-sarB/ver2/RAxML/')
trees = [x for x in os.listdir() if x.endswith('RAxML_bipartitions.sar1-sarB.CD')]

#file in format Acc. number \t name of organism \n
names = open('/Users/kika/ownCloud/membrane-trafficking/trees/ARFs/sar1-sarB/ver2/sar1-sarB_codes_acc.txt')
