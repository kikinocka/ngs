...
os.chdir('/home/kika/MEGAsync/diplonema_mt/1601/transcripts/tadpole/')
xml = open('modules_blast.xml')
...
c = 0
with open('modules_all.txt', 'w') as modules:
	for item in sorted(coordinates.items()):
		c += 1
		for seq in SeqIO.parse('1601_contigs.txt', 'fasta'):
