...
cmd = 'blastx'
task = 'blastx'
query = '/Dcko/ownCloud/membrane-trafficking/rhynchopus_humris_1608/rhRABs_hits.fa'
...
out = '/Dcko/ownCloud/membrane-trafficking/rhynchopus_humris_1608/rhRABs_hits.blast.xml'
evalue = 1
outfmt = 5
hits = 10
word_size = 3
...
output = open('/Dcko/ownCloud/membrane-trafficking/rhynchopus_humris_1608/rhRABs_hits.blast.tsv', 'w')
out_best = open('/Dcko/ownCloud/membrane-trafficking/rhynchopus_humris_1608/rhRABs_hits.best_blast.tsv', 'w')
