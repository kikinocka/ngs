...
cmd = 'blastp'
task = 'blastp'
query = '/mnt/data/kika/blastocrithidia/proteins/Bfru_proteins_final.faa'
db = '/mnt/data/kika/references/kinetoplastids/kinetoplastid_refs.TriTrypDB-61.fa'
out = '/mnt/data/kika/blastocrithidia/proteins/bfru_proteins.fwd_tryps.blast.xml'
evalue = 1e-20
outfmt = 5
hits = 1
word_size = 3
...
output = open('/mnt/data/kika/blastocrithidia/proteins/bfru_proteins.fwd_tryps.blast.tsv', 'w')
out_best = open('/mnt/data/kika/blastocrithidia/proteins/bfru_proteins.fwd_tryps.best_blast.tsv', 'w')
