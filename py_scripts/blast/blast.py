...
cmd = 'blastp'
task = 'blastp'
query = '/Users/kika/ownCloud/membrane-trafficking/BLASTs/trapp-i.fa'
db = '/Users/kika/data/fungi/GCF_000146045.2_R64_protein.faa'
out = '/Users/kika/ownCloud/membrane-trafficking/BLASTs/trapp-i.rev_Scer.blast.xml'
evalue = 1
outfmt = 5
hits = 1
word_size = 3
...
output = open('/Users/kika/ownCloud/membrane-trafficking/BLASTs/trapp-i.rev_Scer.blast.tsv', 'w')
out_best = open('/Users/kika/ownCloud/membrane-trafficking/BLASTs/trapp-i.rev_Scer.best_blast.tsv', 'w')
