...
output = open('/home/kika/ownCloud/euglenophytes/pt_proteome/Eut/Eut_pt_proteins_blast.tsv', 'w')
out_best = open('/home/kika/ownCloud/euglenophytes/pt_proteome/Eut/Eut_pt_proteins_best_blast.tsv', 'w')
