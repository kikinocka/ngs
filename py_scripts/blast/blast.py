...
cmd = 'blastp'
task = 'blastp'
query = '/Users/kika/ownCloud/archamoebae/rho/HMM/ehis_prot_miro.hmm_search_hits.fa'
...
out = '/Users/kika/ownCloud/archamoebae/rho/HMM/ehis_prot_miro.hmm_search_hits.rev_Hsap.blast.xml'
evalue = 1e-04
outfmt = 5
hits = 1
word_size = 3
...
output = open('/Users/kika/ownCloud/archamoebae/rho/HMM/ehis_prot_miro.hmm_search_hits.rev_Hsap.blast.tsv', 'w')
out_best = open('/Users/kika/ownCloud/archamoebae/rho/HMM/ehis_prot_miro.hmm_search_hits.rev_Hsap.best_blast.tsv', 'w')
