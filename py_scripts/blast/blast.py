...
cmd = 'blastx'
task = 'blastx'
query = '/Dcko/ownCloud/membrane-trafficking/rhynchopus_humris_1608/rhRABS.fwd_hits.fa'
...
out = '/Dcko/ownCloud/membrane-trafficking/rhynchopus_humris_1608/rhRABs_rev.blastx.out'
evalue = 1e-5
outfmt = 6
hits = 10
word_size = 3
