...
cmd = 'blastp'
task = 'blastp'
query = '/Users/kika/ownCloud/membrane-trafficking/diplonemids_all/BLASTs/arfs.fa'
...
out = '/Users/kika/ownCloud/membrane-trafficking/diplonemids_all/BLASTs/arfs.rev_Ngru.blast.xml'
evalue = 1e-5
outfmt = 5
hits = 1
word_size = 3
...
output = open('/Users/kika/ownCloud/membrane-trafficking/diplonemids_all/BLASTs/arfs.rev_Ngru.blast.tsv', 'w')
out_best = open('/Users/kika/ownCloud/membrane-trafficking/diplonemids_all/BLASTs/arfs.rev_Ngru.best_blast.tsv', 'w')
