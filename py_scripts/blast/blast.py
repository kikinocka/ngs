...
cmd = 'blastp'
task = 'blastp'
query = '/Users/kika/ownCloud/membrane-trafficking/diplonemids_all/BLASTs/arfGAPs.fa'
...
out = '/Users/kika/ownCloud/membrane-trafficking/diplonemids_all/BLASTs/arfGAPs.rev_Hsap.blast.xml'
evalue = 1e-04
outfmt = 5
hits = 1
word_size = 3
...
output = open('/Users/kika/ownCloud/membrane-trafficking/diplonemids_all/BLASTs/arfGAPs.rev_Hsap.blast.tsv', 'w')
out_best = open('/Users/kika/ownCloud/membrane-trafficking/diplonemids_all/BLASTs/arfGAPs.rev_Hsap.best_blast.tsv', 'w')
