...
os.chdir('/Users/kika/ownCloud/membrane-trafficking/clathrin/tree/ver1/')
inacc = open('CHC.trimal_gt-0.8.aln.marked.treefile')
infasta = SeqIO.parse('CHC.fa', 'fasta')
...
c = 0
with open('CHC_reduced.fa', 'w') as result:
	for seq in infasta:
