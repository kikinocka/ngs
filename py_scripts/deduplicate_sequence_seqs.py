...
os.chdir('/Users/kika/ownCloud/archamoebae/trees/GCS-H/')
infile = SeqIO.parse('gcsh.fa', 'fasta')
out_fasta = open('gcsh_deduplicated.fa', 'w')
out_names = open('gcsh_dupl-names.txt', 'w')
