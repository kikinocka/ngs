...
os.chdir('/Users/kika/ownCloud/archamoebae/trees/Tom60/ver2/')
infile = SeqIO.parse('tom60.fa', 'fasta')
out_fasta = open('tom60_deduplicated.fa', 'w')
out_names = open('tom60_dupl-names.txt', 'w')
