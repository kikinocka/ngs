...
os.chdir('/Users/kika/ownCloud/archamoebae/trees/PFLA/')
infile = SeqIO.parse('pfla.fa', 'fasta')
out_fasta = open('pfla_deduplicated.fa', 'w')
out_names = open('pfla_dupl-names.txt', 'w')
