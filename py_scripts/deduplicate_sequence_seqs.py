...
os.chdir('/Users/kika/ownCloud/archamoebae/trees/PFL')
infile = SeqIO.parse('pfl.fa', 'fasta')
out_fasta = open('pfl_deduplicated.fa', 'w')
out_names = open('pfl_dupl-names.txt', 'w')
