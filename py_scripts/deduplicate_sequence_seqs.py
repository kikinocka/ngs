...
os.chdir('/Users/kika/ownCloud/archamoebae/trees/AK/ver2/')
infile = SeqIO.parse('ak.fa', 'fasta')
out_fasta = open('ak_deduplicated.fa', 'w')
out_names = open('ak_dupl-names.txt', 'w')
