...
os.chdir('/Users/kika/ownCloud/membrane-trafficking/sec13-MS/wdr_tree/ver2/')
infile = SeqIO.parse('wdr.fa', 'fasta')
out_fasta = open('wdr_deduplicated.fa', 'w')
out_names = open('wdr_dupl-names.txt', 'w')
