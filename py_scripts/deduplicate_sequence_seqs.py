...
os.chdir('/Users/kika/ownCloud/EG_pellicle/titins_tree/')
infile = SeqIO.parse('titins.fa', 'fasta')
out_fasta = open('titins_deduplicated.fa', 'w')
out_names = open('titins_dupl-names.txt', 'w')
