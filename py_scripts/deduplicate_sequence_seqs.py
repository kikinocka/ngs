...
os.chdir('/home/kika/ownCloud/euglenophytes/repair/gyraseA/')
infile = SeqIO.parse('gyrA_seqs.fa', 'fasta')
out_fasta = open('gyrA_deduplicated.fa', 'w')
out_names = open('gyrA_dupl-names.txt', 'w')
