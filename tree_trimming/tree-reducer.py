...
print("Mark the branches to be removed in the input tree by a colour (using FigTree). Please use basic colours. ")
print("Phylip not yet supported... ")
print("usage: python3 tree-reducer.py -i eno.fasta -t testtree.nex -c all")
