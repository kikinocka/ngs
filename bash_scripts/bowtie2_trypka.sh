...
base_name='/media/4TB1/blastocrithidia/mapping/p57_ra_bowtie2_DNA/p57_ra_DNA_bw2'
ref='/media/4TB1/blastocrithidia/genome_assembly/p57_ra/p57_ra.fa'

$bw2_dir'bowtie2-build' --threads 32 $ref $base_name

read_dir='/media/4TB1/blastocrithidia/reads/genome/trimmed/'
p1_1=$read_dir'p57_trimmed_1.fq'
p1_2=$read_dir'p57_trimmed_2.fq'
...
$bw2_dir'bowtie2' --very-sensitive -p 32 -x $base_name -1 $p1_1 -2 $p1_2 \
