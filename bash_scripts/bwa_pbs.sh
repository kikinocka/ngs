...
bwa mem -t $PBS_NUM_PPN $assembly $fw $rv > $bam_mapped_paired 2> $report_mapped_paired
...
bwa mem -t $PBS_NUM_PPN $assembly $unpaired > $bam_mapped_unpaired 2> $report_mapped_unpaired
