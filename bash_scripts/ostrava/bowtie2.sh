...
ref=$work_dir'final_assemblies/Oobo_genome_final_masked.fa'
p1_1=$work_dir'o_oborniki/reads/karect_M09_trimmed_75_1.fq'
p1_2=$work_dir'o_oborniki/reads/karect_M09_trimmed_75_2.fq'
base_name='Oobo_bw2'

cd $work_dir'o_oborniki/bowtie2/final/'
