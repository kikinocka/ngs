...
base_name='/media/4TB1/diplonema/mapping/DNA_to_contigs/1604/1604_rest_bw2'
ref='/media/4TB1/diplonema/mapping/DNA_to_contigs/1604/1604_arrays_rest.fasta'

$bw2_dir'bowtie2-build' --threads 32 $ref $base_name

read_dir='/media/4TB1/diplonema/reads/genome/used/1604/'
p1_1=$read_dir'1604_rest_merged_deduplicated.fq'
p1_2=$read_dir'1604_rest_unmerged_deduplicated.fq'
