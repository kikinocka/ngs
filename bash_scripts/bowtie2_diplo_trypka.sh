...
base_name='/media/4TB1/diplonema/mapping/DNA_to_contigs/1608/1608_empty-2_bw2'
ref='/media/4TB1/diplonema/mapping/DNA_to_contigs/1608/1608_empty_contigs.fasta'

$bw2_dir'bowtie2-build' --threads 32 $ref $base_name

read_dir='/media/4TB1/diplonema/reads/genome/used/1608/'
p1_1=$read_dir'1608_used_reads_empty.fastq'
