...
base_name='/media/4TB1/diplonema/mapping/DNA_to_contigs/1618/NODE_41415-2_bw2'
ref='/media/4TB1/diplonema/mapping/DNA_to_contigs/1618/NODE_41415_length_485_cov_989.650838.fasta'

$bw2_dir'bowtie2-build' --threads 32 $ref $base_name

read_dir='/media/4TB1/diplonema/reads/genome/used/1618/'
p1_1=$read_dir'NODE_41415_reads2.fastq'
