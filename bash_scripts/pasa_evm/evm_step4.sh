...
transdecoder='pasa1/pelomyxa_pasa_mysql.assemblies.fasta.transdecoder.gff3'
pasa_gff='pasa2/pelomyxa_pasa_mysql.gene_structures_post_PASA_updates.23203.gff3'
