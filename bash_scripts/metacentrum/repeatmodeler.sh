...
singularity run /cvmfs/singularity.metacentrum.cz/TE-Tools/TE-tools-1.4.sif BuildDatabase \
	-name $name $genome
#Run RepeatModeler
singularity run /cvmfs/singularity.metacentrum.cz/TE-Tools/TE-tools-1.4.sif RepeatModeler \
...
singularity run /cvmfs/singularity.metacentrum.cz/TE-Tools/TE-tools-1.4.sif RepeatMasker \
	-lib $name'-families.fa' -xsmall -pa 7 $genome
