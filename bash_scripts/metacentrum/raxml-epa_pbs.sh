...
data='/storage/brno3-cerit/home/kika/sl_euglenozoa/v9/V9_DeepSea/euglenozoa/'

#copy files to scratch
cp $data'placement/euglenozoa_sags_V9_above99.trimal_gt-0.25_cons-50.aln' $SCRATCHDIR
...
aln='euglenozoa_sags_V9_above99.trimal_gt-0.25_cons-50.aln'
