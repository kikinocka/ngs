...
data='/storage/brno12-cerit/home/kika/trafficking/mantamonas/rabs/2-4-14/ver3/mrbayes/'

#copy files to scratch
cp $data'2-4-14.CD.trimal_gt-0.8.nex' $SCRATCHDIR


#compute on scratch
cd $SCRATCHDIR

aln='2-4-14.CD.trimal_gt-0.8.nex'
