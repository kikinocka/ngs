...
data='/storage/brno3-cerit/home/kika/trafficking/diplonemids_all/ArfGAPs/RAxML/'

#copy files to scratch
cp $data'arfgaps.coded.trimal_gt-0.8.aln' $SCRATCHDIR
...
#proteins
aln='arfgaps.coded.trimal_gt-0.8.aln'
