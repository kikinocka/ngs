...
data='/storage/brno12-cerit/home/kika/sl_euglenozoa/v9/V9_DeepSea/microsporidia/ref_tree/'

#copy files to scratch
cp $data'microsporidia.trimal_gt-0.25_cons-50.aln' $SCRATCHDIR
...
#18S
aln='microsporidia.trimal_gt-0.25_cons-50.aln'
