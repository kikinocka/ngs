...
data='/storage/brno3-cerit/home/kika/sl_euglenozoa/v9/V9_DeepSea/apusomonads/ref_tree/'

#copy files to scratch
cp $data'apusomonads.trimal_gt-0.25_cons-50.aln' $SCRATCHDIR
...
#18S
aln='apusomonads.trimal_gt-0.25_cons-50.aln'
