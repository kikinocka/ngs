...
data='/storage/brno12-cerit/home/kika/trafficking/diplonemids_all/mantamonas/arfs/ver3/raxml/'

#copy files to scratch
cp $data'arfs.CD.trimal_gt-0.8.aln' $SCRATCHDIR
...
# #18S
# aln='apicomplexans.trimal_gt-0.25_cons-50.aln'
