...
data='/storage/brno3-cerit/home/kika/sl_euglenozoa/v9/V9_DeepSea/amoebozoa/ref_tree/'

#copy files to scratch
cp $data'amoebozoa.trimal_gt-0.25_cons-50.aln' $SCRATCHDIR
...
#18S
aln='amoebozoa.trimal_gt-0.25_cons-50.aln'
