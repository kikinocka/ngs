...
genome_dir='/storage/brno12-cerit/home/kika/blastocystis/ASM2740638v1/'
...
cp $genome_dir'GCA_027406385.1_ASM2740638v1_genomic.fna' $SCRATCHDIR
...
genome='GCA_027406385.1_ASM2740638v1_genomic.fna'
# bam='Tboi_ht2_sorted.pass.bam'
prot='Stramenopiles.fa'
name='blastocystis_s21'
