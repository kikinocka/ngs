...
cp $data_dir'tree_MFP/asr/CHC_opisthokonta.man_trim.CD.rooted.treefile' $SCRATCHDIR
...
iqtree -m LG+C40+G+F+I+R5 -nt AUTO -ntmax $PBS_NUM_PPN -quiet -s $aln -te $tree -asr
