...
cp $data_dir'ku70_pilon6.fa' $SCRATCHDIR
cp $data_dir'bw2_mapping/pilon6/ku70_p6_bw2_sorted.bam' $SCRATCHDIR
cp $data_dir'bw2_mapping/pilon6/ku70_p6_bw2_sorted.bam.bai' $SCRATCHDIR

pilon='/storage/brno2/home/kika/tools/pilon-1.23.jar'
assembly='ku70_pilon6.fa'
bam='ku70_p6_bw2_sorted.bam'
index='ku70_p6_bw2_sorted.bam.bai'
