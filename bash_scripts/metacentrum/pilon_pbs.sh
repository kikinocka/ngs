...
cp $data_dir'wt_pilon7.fa' $SCRATCHDIR
cp $data_dir'bw2_mapping/pilon7/wt_p7_bw2_sorted.bam' $SCRATCHDIR
cp $data_dir'bw2_mapping/pilon7/wt_p7_bw2_sorted.bam.bai' $SCRATCHDIR

pilon='/storage/brno2/home/kika/tools/pilon-1.23.jar'
assembly='wt_pilon7.fa'
bam='wt_p7_bw2_sorted.bam'
index='wt_p7_bw2_sorted.bam.bai'
