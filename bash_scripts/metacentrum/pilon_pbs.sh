...
cp $data_dir'ku70_pilon2.fa' $SCRATCHDIR
cp $data_dir'bw2_mapping/pilon2/ku70_p2_bw2_sorted.bam' $SCRATCHDIR
cp $data_dir'bw2_mapping/pilon2/ku70_p2_bw2_sorted.bam.bai' $SCRATCHDIR

pilon='/storage/brno2/home/kika/tools/pilon-1.23.jar'
assembly='ku70_pilon2.fa'
bam='ku70_p2_bw2_sorted.bam'
index='ku70_p2_bw2_sorted.bam.bai'
