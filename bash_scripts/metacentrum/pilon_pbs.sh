...
cp $data_dir'ku70_pilon8.fa' $SCRATCHDIR
cp $data_dir'bw2_mapping/pilon8/ku70_p8_bw2_sorted.bam' $SCRATCHDIR
cp $data_dir'bw2_mapping/pilon8/ku70_p8_bw2_sorted.bam.bai' $SCRATCHDIR

pilon='/storage/brno2/home/kika/tools/pilon-1.23.jar'
assembly='ku70_pilon8.fa'
bam='ku70_p8_bw2_sorted.bam'
index='ku70_p8_bw2_sorted.bam.bai'
