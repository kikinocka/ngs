...
cp $data_dir'wt_pilon2.fa' $SCRATCHDIR
cp $data_dir'bw2_mapping/pilon2/wt_p2_bw2_sorted.bam' $SCRATCHDIR
cp $data_dir'bw2_mapping/pilon2/wt_p2_bw2_sorted.bam.bai' $SCRATCHDIR
