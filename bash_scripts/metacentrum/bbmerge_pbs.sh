...
cp $raw'15_GTAGCC_L001_R1_001.fastq.bz2' $raw'15_GTAGCC_L001_R2_001.fastq.bz2' $SCRATCHDIR

fw='15_GTAGCC_L001_R1_001.fastq.bz2'
rv='15_GTAGCC_L001_R2_001.fastq.bz2'
merged='15_GTAGCC_merged.fq.gz'
un1='15_GTAGCC_unmerged_R1.fq.gz'
un2='15_GTAGCC_unmerged_R2.fq.gz'
report='15_GTAGCC_bbmerge_report.txt'
