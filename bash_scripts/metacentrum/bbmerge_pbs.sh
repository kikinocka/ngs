...
cp $raw'3_GAACGA_L001_R1_001.fastq.bz2' $raw'3_GAACGA_L001_R2_001.fastq.bz2' $SCRATCHDIR

fw='3_GAACGA_L001_R1_001.fastq.bz2'
rv='3_GAACGA_L001_R2_001.fastq.bz2'
merged='3_GAACGA_merged.fq.gz'
un1='3_GAACGA_unmerged_R1.fq.gz'
un2='3_GAACGA_unmerged_R2.fq.gz'
report='3_GAACGA_bbmerge_report.txt'
