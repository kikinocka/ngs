...
cp $raw'6_ACATCG_L001_R1_001.fastq.bz2' $raw'6_ACATCG_L001_R2_001.fastq.bz2' $SCRATCHDIR

fw='6_ACATCG_L001_R1_001.fastq.bz2'
rv='6_ACATCG_L001_R2_001.fastq.bz2'
merged='6_ACATCG_merged.fq.gz'
un1='6_ACATCG_unmerged_R1.fq.gz'
un2='6_ACATCG_unmerged_R2.fq.gz'
report='6_ACATCG_bbmerge_report.txt'
