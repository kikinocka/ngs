...
cp $raw'13_CGTGAT_L001_R1_001.fastq.bz2' $raw'13_CGTGAT_L001_R2_001.fastq.bz2' $SCRATCHDIR

fw='13_CGTGAT_L001_R1_001.fastq.bz2'
rv='13_CGTGAT_L001_R2_001.fastq.bz2'
merged='13_CGTGAT_merged.fq.gz'
un1='13_CGTGAT_unmerged_R1.fq.gz'
un2='13_CGTGAT_unmerged_R2.fq.gz'
report='13_CGTGAT_bbmerge_report.txt'
