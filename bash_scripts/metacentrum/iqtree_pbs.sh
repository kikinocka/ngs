...
datadir='/storage/brno3-cerit/home/kika/trafficking/diplonemids_COPII/ver8/'

#copy files to scratch
# cp $datadir'/'*.aln $SCRATCHDIR
cp $datadir'sec13.CD.trimal_gt-0.8.aln' $SCRATCHDIR


#compute on scratch
cd $SCRATCHDIR
aln='sec13.CD.trimal_gt-0.8.aln'
guide='guide_sec13.CD'
