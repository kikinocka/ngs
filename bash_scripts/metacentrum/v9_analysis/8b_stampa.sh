...
VSEARCH="vsearch"
SSU_V4="/storage/brno3-cerit/home/kika/pr2_version_4.12.0_18S_taxo_long.fasta"
SSU_V9="/storage/brno3-cerit/home/kika/pr2_version_4.12.0_18S_taxo_long.fasta"
OUTPUT_PREFIX="fasta."
...
python2 "../8c_stampa_merge.py" "${PWD}"
