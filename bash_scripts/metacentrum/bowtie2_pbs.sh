...
cp $data'reads/SRR1028161_trimmed_1.fq.gz' $SCRATCHDIR
cp $data'reads/SRR1028161_trimmed_2.fq.gz' $SCRATCHDIR
cp $data'reads/SRR1593518_trimmed_1.fq.gz' $SCRATCHDIR
cp $data'reads/SRR1593518_trimmed_2.fq.gz' $SCRATCHDIR
