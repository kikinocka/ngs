...
datadir='/storage/brno12-cerit/home/kika/trafficking/clathrin/ver5/'
...
iqtree -m LG+C40+G+F+R5 -T $PBS_NUM_PPN -B $bb --nmax $nm --quiet --safe -s $aln --tree-freq $guide_tree -g $constr --boot-trees
