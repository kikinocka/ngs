...
data='/storage/brno3-cerit/home/kika/oil_sands/Lane26_18S_V9/placement/above99/only_tree/'

#copy files to scratch
cp $data'mlsb_metamonads.trimal_gt-0.8.aln' $SCRATCHDIR


#compute on scratch
cd $SCRATCHDIR

aln='mlsb_metamonads.trimal_gt-0.8.aln'
out='mlsb_metamonads'
