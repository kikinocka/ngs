...
data='/storage/brno3-cerit/home/kika/trafficking/ArfGAPs/ag-smap-acap/RAxML/'

#copy files to scratch
cp $data'ag-smap-acap.trimal_gt-0.8.aln' $SCRATCHDIR
...
#proteins
aln='ag-smap-acap.trimal_gt-0.8.aln'
