...
data='/storage/brno3-cerit/home/kika/oil_sands/Lane26_18S_V9/metamonada/PCRs/'

#copy files to scratch
cp $data'metamonads-AFR1.trimal_gt-0.8.aln' $SCRATCHDIR
