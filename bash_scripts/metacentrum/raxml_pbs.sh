...
data='/storage/brno3-cerit/home/kika/trafficking/ARFs/sar1-sarB/ver2/RAxML/'

#copy files to scratch
cp $data'sar1-sarB.CD.trimal_gt-0.8.aln' $SCRATCHDIR
...
#proteins
aln='sar1-sarB.CD.trimal_gt-0.8.aln'
