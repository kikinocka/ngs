...
data_dir='/storage/brno3-cerit/home/kika/oil_sands/metagenomes/P3S_1-02B_L001-ds.971c07c67a83443891de04bf749cee0b/5-tiara/'
...
#copy files back
rm $contigs
cp -r * $data_dir'6-metaeuk/profiles/'
