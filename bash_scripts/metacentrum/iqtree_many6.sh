...
cp $data_dir'Tgon.trimal_gt-0.8.aln' $SCRATCHDIR
cp $data_dir'Tpse.trimal_gt-0.8.aln' $SCRATCHDIR
cp $data_dir'TspP.trimal_gt-0.8.aln' $SCRATCHDIR
cp $data_dir'Tsub.trimal_gt-0.8.aln' $SCRATCHDIR
cp $data_dir'Tthe.trimal_gt-0.8.aln' $SCRATCHDIR
cp $data_dir'Ttra.trimal_gt-0.8.aln' $SCRATCHDIR
cp $data_dir'Tvag.trimal_gt-0.8.aln' $SCRATCHDIR
cp $data_dir'Umay.trimal_gt-0.8.aln' $SCRATCHDIR
cp $data_dir'Vver.trimal_gt-0.8.aln' $SCRATCHDIR
