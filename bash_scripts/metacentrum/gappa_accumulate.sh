...
data='/storage/brno3-cerit/home/kika/sl_euglenozoa/v9/V9_DeepSea/apusomonads/placement/'

#copy files to scratch
cp $data'RAxML_portableTree.EPARUN_apusomonads.jplace' $SCRATCHDIR


#compute on scratch
cd $SCRATCHDIR

jplace='RAxML_portableTree.EPARUN_apusomonads.jplace'
