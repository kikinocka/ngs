...
genome_dir='/storage/brno12-cerit/home/kika/blastocystis/ASM2924171v1/'
...
cp $genome_dir'GCA_029241715.1_ASM2924171v1_genomic.fna' $SCRATCHDIR
...
genome='GCA_029241715.1_ASM2924171v1_genomic.fna'
# bam='Tboi_ht2_sorted.pass.bam'
prot='Stramenopiles.fa'
name='blastocystis_CHMP1T05'
