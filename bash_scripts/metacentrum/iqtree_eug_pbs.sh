...
datadir='/storage/brno3-cerit/home/kika/sags/phylogenomics/concat_ver7_C60_ufb/'
...
iqtree -m LG+C60+F+G -nt AUTO -ntmax $PBS_NUM_PPN -bb $bb -quiet -s $aln -ft $guide_tree -wsr
