...
#running: python3.5 ECquery2.py -e eclist.txt -f EL_zorfome2.fasta -q longa.ko.txt
#running: python3.5 ECquery2.py -e eclist.txt -f EL_zorfome2.fasta -q EL2ghostz.ko.txt

#searching for orthology numbers
#running: python3.5 ECquery2.py -p ko00900 -f EL_zorfome2.fasta -q longa.ko.txt
#running: python3.5 ECquery2.py -p ko00900 -f EL_zorfome2.fasta -q EL2ghostz.ko.txt
